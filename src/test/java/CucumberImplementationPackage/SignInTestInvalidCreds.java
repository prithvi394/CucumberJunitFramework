...
public class SignInTestInvalidCreds extends BaseClass {
	
	 Logger stdLog = LogManager.getLogger(SignInTestInvalidCreds.class);
	...
	@When("^F002 S002 User enters invalid UserName and Password$")
